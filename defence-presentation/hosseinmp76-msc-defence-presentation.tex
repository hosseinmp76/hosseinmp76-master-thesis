...
\begin{frame}{Aapplications}
	\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
		...
		\begin{itemize}
			\item<1-> distributed storage %\cite{arya}
			\item<2-> Machine learning%: \cite{datashuff}
		\end{itemize}
...
\begin{frame}{PICOD Defination}
	...
	\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
		...
		\begin{itemize}
			...
			\item<3-> Client $i$ knows varibles with indeices in $S_i$: $X[S_1] = \{B_1, B_2\}$
		\end{itemize}
		\column{.5\textwidth}
...
\subsection{Feasible Table \& Co-sets \& Source Coding}
		...
		\begin{example}
			\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
				...
				\begin{enumerate}
					...
					\item<2-> Consider side-information graph $G$.
					\item<3-> $T_1$ is not a feasible graph bacause $C_3$ confuses between messages.
					\item<4-> $T_2$ is a feasible table.
				\end{enumerate}
				\column{.4\textwidth}
				\centering
				\begin{tikzpicture}[->, >=stealth, auto, semithick]
...
\begin{frame}{ Co-sets }
	\begin{enumerate}[]
		\item<1->\begin{definition}[Co-sets]
...
\begin{frame}{Feasible Table \& Co-sets: Example 2}
	\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
		...
		\begin{enumerate}
			...
			\item<3-> Transmitting table label is suffecint!
		\end{enumerate}
		\column{.5\textwidth}
		\centering
		\begin{tikzpicture}[->, >=stealth, auto, semithick]
...
\begin{frame}{Main Theorem: Formal}
	\begin{theorem}[Duality of PLIC \& PLSC]
